            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/membership/' . $membership->id . '/edit') }}" title="Edit Membership"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Membership Type </th><td> {{ $membership->membership_type }} </td></tr><tr><th> Reg Email </th><td> {{ $membership->reg_email }} </td></tr><tr><th> Reg Email Repeat </th><td> {{ $membership->reg_email_repeat }} </td></tr>
                                </tbody>
                            </table>
                        </div>
