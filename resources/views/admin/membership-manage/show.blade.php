                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="6" class="text-right">
                                                ...
                                                <img class="img-thumbnail member-photo" src="{{ url('/new_uploads/'.$Membership->member_photo)}}" alt="...">      
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">{{ link_to_asset('/new_uploads/'.$Membership->member_payment_doc,'Click Here To Download', array('class'=>'hidden-print')) }} </td>
                                    </tr>
